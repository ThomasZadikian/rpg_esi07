...
public async Task<List<AuditLog>> GetAllAsync() => await _context.AuditLogs.OrderBy(x => x.Id).ToListAsync();

public async Task<AuditLog?> GetByIdAsync(int id) => await _context.AuditLogs.FindAsync(id);
